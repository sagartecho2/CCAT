...
function move_right(id,element)
{
  var unassigned_list=$(id).find(element);
      unassigned_list.each(function(i,item)
    {
      $("#unassigned_member").append(item);
      $("#unassigned_member").find("li").removeClass("active");
    })
}

function move_left(id,element)
{
  var unassigned_list=$(id).find(element);
      unassigned_list.each(function(i,item)
    {
      $("#assigned_members").append(item);
      $("#assigned_members").find("li").removeClass("active");
    })
}
